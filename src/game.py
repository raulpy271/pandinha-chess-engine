...
from src.movements.king_atack import king_is_atacked_by_bishop_or_queen, king_is_atacked_by_knight, king_is_atacked_by_oponent_king, king_is_atacked_by_pawn, king_is_atacked_by_rook_or_queen
...
class Game(Board):
    ...
    def king_is_not_secure(self, king_index: int) -> bool:
        return any([
            ...
            king_is_atacked_by_oponent_king(self.squares, king_index, self.current_player)
        ])
